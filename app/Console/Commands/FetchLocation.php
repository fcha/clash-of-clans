...
class FetchLocation extends Command
{
     ...
     * @var string
     */
    protected $signature = 'coc:fetchLocation';
     ...
     * @var string
     */
    protected $description = 'Fetches and stores location information from SuperCell\'s API';
    ...
    {
        $results = $this->fetcher->getLocations();
    ...
    {
        $resultTypeId = config('api.results.types.locations');
