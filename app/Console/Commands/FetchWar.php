...
class FetchWar extends Command
{
     ...
     * @var string
     */
    protected $signature = 'coc:fetchWar';
     ...
     * @var string
     */
    protected $description = 'Fetches and stores clan war log information from SuperCell\'s API';
    ...
    {
        $results = $this->fetcher->getWarLog();
    ...
    {
        $resultTypeId = config('api.results.types.clan_war');
