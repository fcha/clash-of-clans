...
use App\API\src\ClashOfClans\Results\Digestors\War as Digestor;

class ProcessWar extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'coc:processWar';
    ...
    /**
     * @var \App\API\src\ClashOfClans\Results\Digestors\War
     */
    protected $digestor;
    ...
    /**
     * @param \App\API\src\ClashOfClans\Results\Digestors\War    $digestor
